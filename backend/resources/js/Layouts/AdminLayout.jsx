            ...
            <aside className="w-64 bg-white border-r border-gray-200 hidden md:flex flex-col shrink-0 h-screen select-none">
                ...
                <div className="p-4 border-t shrink-0 space-y-2 bg-white">
                    ...
                    <button
                        type="button"
                        onClick={handleLogout}
                        className="w-full flex items-center gap-2 px-3 py-2 rounded-lg text-sm font-bold text-red-600 hover:bg-red-50 transition cursor-pointer"
                    >
                        <LogOut size={16} /> Logout
                    </button>
                </div>
            ...
            {mobileOpen && (
                <div className="fixed inset-0 z-40 md:hidden">
                    ...
                    <aside className="absolute left-0 top-0 bottom-0 w-64 bg-white shadow-xl flex flex-col h-full">
                        ...
                        <div className="p-4 border-t shrink-0 space-y-2 bg-white">
                            <Link href="/" className="block text-sm font-bold text-slate-600 hover:text-rose-600">← Back to Store</Link>
                            <button
                                type="button"
                                onClick={() => { setMobileOpen(false); handleLogout(); }}
                                className="w-full flex items-center gap-2 px-3 py-2 rounded-lg text-sm font-bold text-red-600 hover:bg-red-50 cursor-pointer"
                            >
                                <LogOut size={16} /> Logout
                            </button>
                        </div>
