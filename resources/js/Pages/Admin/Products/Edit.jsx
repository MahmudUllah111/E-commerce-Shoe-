...
export default function Edit({ product, categories=[], allCategories=[], brands=[] }){
    ...
    const submit=(e)=>{
        ...
        const payload={
            ...
            is_new: data.is_new?1:0, is_featured: data.is_featured?1:0, is_on_sale: data.is_on_sale?1:0,
                    ...
                    <div className="bg-white border border-gray-200 rounded-xl p-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div className="flex items-center gap-6 pt-6">
                                ...
                                <label className="flex items-center gap-2 text-sm font-bold"><input type="checkbox" checked={data.is_on_sale} onChange={e=> setData('is_on_sale', e.target.checked)} className="rounded border-gray-300 text-rose-600 focus:ring-rose-500" /> On Sale</label>
                            </div>
                        </div>
                    </div>
