...
Route::middleware('auth')->group(function(){
    ...
    Route::post('/wishlist/request', [AccountController::class, 'wishlistRequest'])->name('wishlist.request');
...
Route::post('/contact', function(\Illuminate\Http\Request $request){
    ...
    try {
        ...
        \Illuminate\Support\Facades\Mail::raw($body, function ($msg) use ($adminEmail, $data, $subject) {
            $msg->to($adminEmail)
                ->subject($subject)
...
// Direct shortcuts for customer care pages
Route::get('/about', fn() => redirect()->route('pages.show', 'about'));
Route::get('/faq', fn() => redirect()->route('pages.show', 'faq'));
Route::get('/return-policy', fn() => redirect()->route('pages.show', 'return-policy'));
Route::get('/returns', fn() => redirect()->route('pages.show', 'return-policy'));
